    ...
    <div style={{ width: "100%" }}>
        ...
        <div style={{ position: "relative", display: "grid", gridTemplateColumns: "1.5fr 1fr", gap: 56, alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 12, marginTop: 32, flexWrap: "wrap" }}>
              <Link href="/caste/swap" style={{ padding: "18px 32px", background: "var(--acid)", color: "var(--ink-000)", fontFamily: "var(--f-display)", fontSize: 16, letterSpacing: "0.1em", border: "none", borderRadius: 4, textDecoration: "none", boxShadow: "0 6px 0 var(--acid-lo), 0 14px 32px oklch(0.90 0.20 115 / 0.35)" }}>
                BUY $CASTE — $6.66666 / UNIT
              </Link>
              <Link href="/caste/mycards" style={{ padding: "18px 28px", background: "transparent", color: "var(--gold-hi)", fontFamily: "var(--f-display)", fontSize: 16, letterSpacing: "0.1em", border: "1px solid var(--gold)", borderRadius: 4, textDecoration: "none" }}>
                FLIP MY SEALED ↗
              </Link>
            </div>
      ...
      <section style={{ padding: "20px 60px 48px" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 14, marginBottom: 18 }}>
          ...
          <div style={{ flex: 1, height: 1, background: "var(--ink-400)" }} />
          <Link href="/caste/activity" className="mono" style={{ fontSize: 11, color: "var(--acid)", letterSpacing: "0.15em", textDecoration: "none" }}>
            FULL ACTIVITY →
          </Link>
        </div>
